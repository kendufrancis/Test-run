...
#   source                            = "./modules/Networking/"
  ...
  service_protocols                 = locals.service_protocols[each.key]
  service_ports                     = locals.service_ports[each.key]
  # asg_name                          = aws.autoscaling_group.asg 
  linked_role_arn                   = var.service_linked_role_arn
...
# modules/Newtworking/ec2.tf" 
  ...
  # key_name                = var.key_name
  # instance_name           = var.instance_name
  # user_data               = var.user_data        #filebase64("user_data.sh")
...
#   source         = "../../Modules/ecs"
#   environment    = "staging"
#   cluster_name   = "staging-us-east-1-ecs"
# }
